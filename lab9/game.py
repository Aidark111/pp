...
background = pygame.image.load("/Users/sansyzbaidarkhan/Desktop/pp2/lab9/png/AnimatedStreet.png")
...
class Coins(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/sansyzbaidarkhan/Desktop/pp2/lab9/png/Coin.png")
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/sansyzbaidarkhan/Desktop/pp2/lab9/png/Enemy.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, SCREEN_WIDTH - 40), 0)
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/sansyzbaidarkhan/Desktop/pp2/lab9/png/Player.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound('/Users/sansyzbaidarkhan/Desktop/pp2/lab9/audio/crash.wav').play()
        time.sleep(1)
