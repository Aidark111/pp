...
background = pygame.image.load("/Users/sansyzbaidarkhan/Desktop/pp2/lab10/SnakeGame/img/green.jpg")
eat = pygame.mixer.Sound("/Users/sansyzbaidarkhan/Desktop/pp2/lab10/SnakeGame/sounds/eat.mp3")
pygame.mixer.music.load("/Users/sansyzbaidarkhan/Desktop/pp2/lab10/SnakeGame/sounds/theme.mp3")
...
class Food:
    def __init__(self, x, y):
        ...
        #загрузка сюрфэйса
        self.image = pygame.image.load("/Users/sansyzbaidarkhan/Desktop/pp2/lab10/SnakeGame/img/apple.png")
...
class Block:
    def __init__(self, x, y):
        ...
        self.location = Point(self.x, self.y)
        #загрузка сюрфэйса
        self.image = pygame.image.load("/Users/sansyzbaidarkhan/Desktop/pp2/lab10/SnakeGame/img/block.png")
        self.rect = self.image.get_rect()
...
class Snake:
    def __init__(self):
        ...
        self.image = pygame.image.load("/Users/sansyzbaidarkhan/Desktop/pp2/lab10/SnakeGame/img/yellow.png")
        self.rect = self.image.get_rect()
        self.dx = 0
        self.dy = 0
...
while restart:
    ...
    pygame.display.set_caption("rnake")
